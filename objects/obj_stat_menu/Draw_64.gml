...
scr_draw_txt_border(155,61,"Def: ",c_black,c_light_yellow);
scr_draw_txt_border(190,61,string(curr_actor.defense_stat),c_black,c_white);
scr_draw_txt_border(85,50,"Skill: ",c_black,c_light_yellow);
scr_draw_txt_border(120,50,string(curr_actor.skill_stat),c_black,c_white);
scr_draw_txt_border(85,61,"Spd: ",c_black,c_light_yellow);
scr_draw_txt_border(120,61,string(curr_actor.skill_stat),c_black,c_white);
